...
bool DataZone::Draw()
{
    ...
    if (data[0] != 0)
    {
        if (ValueFPGA::IsData())
        {
            ...
            {
                Indicator::DrawDataAboutRight(data.c_str(), x0 + RIGHT_DIGITS, y0 + 1, Color::FILL, Color::VOID);
            }
        }
        else
        {
            ...
            {
                Indicator::DrawDataAboutRight(data.c_str(), RIGHT_DIGITS, y0 + 1, Color::FILL, Color::VOID);
            }
        }
    }
